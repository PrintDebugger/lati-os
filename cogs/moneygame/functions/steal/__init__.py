...
class StealCommand:
    ...
    def get_steal_result(stealer, victim):
        if "6" in victim.active_items:
            ...
            if death_chance > 0.75 | (not "4" in stealer.active_items and death_chance > 0.5):
                return "OTHER", {}
